...
owm.getForecast = function (options) {
  ...
  .then(payload => {
    //const day_min = payload.map(list => list.main.temp_min)
    //var day_max = payload.map(migraine => migraine.createdAt.slice(6,10))
    //console.log(day_min);
    console.log(payload);
    $('#day1').html(payload.list["0"].dt_txt.slice(5,10)+'-2018');
    //$('#day1-temp').html(payload.list["0"].main.temp_min + '°' + ' || ' + payload.list["0"].main.temp_max + '°');
    ...
    $('#day2').html(payload.list["8"].dt_txt.slice(5,10)+'-2018');
    ...
    $('#day3').html(payload.list["16"].dt_txt.slice(5,10)+'-2018');
    ...
    $('#day4').html(payload.list["24"].dt_txt.slice(5,10)+'-2018');
    ...
    $('#day5').html(payload.list["32"].dt_txt.slice(5,10)+'-2018');
